...
describe('alignment.model', () => {
  describe('getAlignment', () => {
    it.each([
      ...
      ['true neutral', Alignment.TN], ['neutral', Alignment.TN], ['tn', Alignment.TN], ['nn', Alignment.TN], ['n', Alignment.TN],
    ...
    it.each(['na', 'no', 'none', 'no alignment'])('should return no alignment', str => expect(getAlignment(str)).toBe(Alignment.NA));
